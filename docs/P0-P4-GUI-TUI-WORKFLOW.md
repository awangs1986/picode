...
- **Pi ecosystem**: Herdr provides an official Pi integration and persistent agent-aware terminal panes. The reviewed project is `ogulcancelik/herdr` release `v0.7.5`, dual licensed AGPL-3.0-or-later/commercial, with Windows described as preview support.
