...
const controlSubjects = new Set(["run", "rpc", "serve", "session", "subagent", "slice", "capsule", "worktree", "capability", "chat", "task", "gate", "harness", "permissions", "account", "tools", "doctor", "help"]);
