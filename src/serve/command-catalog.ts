...
const builtin: RemoteSlashCommand[] = [
  ...
  { name: "import", description: "Import account/session data on the PC", remote: false },
...
const picode: RemoteSlashCommand[] = [
  ...
  { name: "picode-compact", description: "Compact through the Picode extension API", remote: false },
  ...
  { name: "chat-import", description: "Import a foreign transcript on the PC", remote: false },
  ...
  { name: "accounts", description: "List existing Host accounts", argumentHint: "list", remote: true },
